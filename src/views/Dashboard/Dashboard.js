...
//   const [averageLandsPerHand, setAverageLandsPerHand] = useState(0);
...
//       setDeck(parsedDeck);
//       calculateStats(parsedDeck);
//     }
//   }, []);

//   const calculateStats = (deck) => {
//     const manaColors = ["W", "U", "B", "R", "G"];
//     const manaCount = { W: 0, U: 0, B: 0, R: 0, G: 0 };
//     let landCount = 0;
...
//             manaCount[color] += card.quantity;
//           }
//         });
//       }
//     });

//     setManaDistribution(manaCount);
//     setAverageLandsPerHand((landCount / deck.length) * 7);
//   };
...
//             <Thead>
//               <Tr>
//                 <Th color="gray.400">Card Name</Th>
//                 <Th color="gray.400">Quantity</Th>
//                 <Th color="gray.400">Zone</Th>
//               </Tr>
//             </Thead>
//             <Tbody>
//               {deck.map((card, index) => (
